...
public class SandboxMapas
{
    ...
    public String getPrimera( )
    {
        ...
        String cadenaMenor = Collections.min(llaves);
        return cadenaMenor;
    }
    ...
    public String getUltima( )
    {
        ...
        String cadenaMayor = Collections.max(valores);
        return cadenaMayor;
    ...
    {
    	Map<String,String> mapaEntradas = new HashMap<>();
    	for(Map.Entry<String,String> entry : mapaCadenas.entrySet())
    	{
    		String llaveMayuscula = entry.getKey().toUpperCase();
    		mapaEntradas.put(llaveMayuscula, entry.getValue());
    	}
    	mapaCadenas=mapaEntradas;
    }
