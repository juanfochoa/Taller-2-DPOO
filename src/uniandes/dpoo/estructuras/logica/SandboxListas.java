...
public class SandboxListas
{
    ...
    {
        List<Integer> copiaEntero = new ArrayList<Integer>();

        for (Integer numero : listaEnteros) {
            copiaEntero.add(numero);
        }
    ...
    {
    	List<String> copiaCadena = new LinkedList<String>();

        for (String cadena : listaCadenas) {
            copiaCadena.add(cadena);
        }
